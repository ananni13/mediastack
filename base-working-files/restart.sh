...
FOLDER_FOR_YAMLS=/home/andrea/mediastack/base-working-files
...
# Force-remove all Docker images - THIS WILL FORCE ALL DOCKER IMAGES TO BE DOWNLOADED AGAIN
# sudo docker image prune -a -f
# Force-remove all non-persistent Docker volumes
sudo docker volume prune -f
# Force-remove all Docker networks
