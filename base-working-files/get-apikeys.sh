...
# Folder where the yaml and .env files are located
export FOLDER_FOR_YAMLS=/home/andrea/mediastack/base-working-files
# Folder where your media is locate
export FOLDER_FOR_MEDIA=/home/andrea/media
# Folder where MediaStack stores persistent data and configurations
export FOLDER_FOR_DATA=/home/andrea/docker/appdata
